...
function interpolate(value, inputRange, outputRange, easing, extrapolate, extrapolateLeft, extrapolateRight, _) {
  ...
  var tmp$1 = UtilsRN$BsReactNativeWeb.option_map(extrapolateString, extrapolate);
  if (tmp$1) {
    tmp.extrapolate = tmp$1[0];
  }
  var tmp$2 = UtilsRN$BsReactNativeWeb.option_map(extrapolateString, extrapolateLeft);
  if (tmp$2) {
    tmp.extrapolateLeft = tmp$2[0];
  }
  var tmp$3 = UtilsRN$BsReactNativeWeb.option_map(extrapolateString, extrapolateRight);
  if (tmp$3) {
...
function animate$2(value, velocity, deceleration, isInteraction, useNativeDriver, onComplete, iterations, _) {
  ...
  var tmp$1 = UtilsRN$BsReactNativeWeb.optBoolToOptJsBoolean(isInteraction);
  if (tmp$1) {
    tmp.isInteraction = tmp$1[0];
  }
  var tmp$2 = UtilsRN$BsReactNativeWeb.optBoolToOptJsBoolean(useNativeDriver);
  if (tmp$2) {
...
var Easing_000 = ReactNative.Easing.bounce;

var Easing_001 = ReactNative.Easing.circle;

var Easing_002 = ReactNative.Easing.cubic;

var Easing_003 = ReactNative.Easing.ease;

var Easing_004 = ReactNative.Easing.exp;

var Easing_005 = ReactNative.Easing.linear;

var Easing_006 = ReactNative.Easing.poly;

var Easing_007 = ReactNative.Easing.quad;

var Easing_008 = ReactNative.Easing.sin;

var Easing_009 = ReactNative.Easing.step0;

var Easing_010 = ReactNative.Easing.step1;

function Easing_011(prim) {
  return ReactNative.Easing.back(prim);
}

function Easing_012(prim) {
  return ReactNative.Easing.elastic(prim);
}

function Easing_013(prim) {
  return ReactNative.Easing.in_(prim);
}

function Easing_014(prim) {
  return ReactNative.Easing.inOut(prim);
}

function Easing_015(prim) {
  return ReactNative.Easing.out(prim);
}

function Easing_016(prim, prim$1, prim$2, prim$3) {
