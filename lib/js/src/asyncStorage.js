...
function getItem(key, callback, _) {
  if (callback) {
    ...
    return ReactNative.AsyncStorage.getItem(key, undefined).then(to_opt);
  }
}
...
function getAllKeys(callback, _) {
  if (callback) {
    ...
    return ReactNative.AsyncStorage.getAllKeys(undefined).then(to_opt);
  }
}
...
function multiGet(keys, callback, _) {
  if (callback) {
    ...
    return ReactNative.AsyncStorage.multiGet(keys, undefined).then(to_opt);
  }
}
