...
function CreateComponent(Impl) {
  ...
  var make = function (onError, onLayout, onLoad, onLoadEnd, onLoadStart, resizeMode, source, style, testID, resizeMethod, accessibilityLabel, accessible, blurRadius, capInsets, defaultSource, onPartialLoad, onProgress) {
    var partial_arg = {
      ...
      resizeMode: Js_undefined.fromOption(UtilsRN$BsReactNativeWeb.option_map(encodeResizeMode, resizeMode)),
      source: Js_undefined.fromOption(UtilsRN$BsReactNativeWeb.option_map(encodeSource, source)),
      style: Js_undefined.fromOption(style),
      testID: Js_undefined.fromOption(testID),
      resizeMethod: Js_undefined.fromOption(UtilsRN$BsReactNativeWeb.option_map(encodeResizeMethod, resizeMethod)),
      ...
      defaultSource: Js_undefined.fromOption(UtilsRN$BsReactNativeWeb.option_map(encodeDefaultSource, defaultSource)),
      onPartialLoad: Js_undefined.fromOption(onPartialLoad),
      onProgress: Js_undefined.fromOption(UtilsRN$BsReactNativeWeb.option_map((function (x, y) {
...
function include_000(prim, prim$1, prim$2, prim$3, prim$4, prim$5, prim$6, prim$7, prim$8, _) {
  var tmp = {
    uri: prim
  };
  if (prim$1) {
...
function include_001(prim, prim$1, prim$2, prim$3, _) {
  var tmp = {
    uri: prim
  };
  if (prim$1) {
...
var imageURISource = include_000;

var defaultURISource = include_001;
