...
function make(accessibilityLabel, accessible, hitSlop, onAccessibilityTap, onLayout, onMagicTap, responderHandlers, pointerEvents, removeClippedSubviews, style, testID, accessibilityComponentType, accessibilityLiveRegion, collapsable, importantForAccessibility, needsOffscreenAlphaCompositing, renderToHardwareTextureAndroid, accessibilityTraits, accessibilityViewIsModal, shouldRasterizeIOS, autoCapitalize, autoCorrect, autoFocus, blurOnSubmit, caretHidden, defaultValue, editable, keyboardType, maxLength, multiline, onBlur, onChange, onChangeText, onContentSizeChange, onEndEditing, onFocus, onScroll, onSelectionChange, onSubmitEditing, placeholder, placeholderTextColor, returnKeyType, secureTextEntry, selectTextOnFocus, selection, selectionColor, value, disableFullscreenUI, inlineImageLeft, inlineImagePadding, numberOfLines, returnKeyLabel, textBreakStrategy, underlineColorAndroid, clearButtonMode, clearTextOnFocus, dataDetectorTypes, enablesReturnKeyAutomatically, keyboardAppearance, onKeyPress, selectionState, spellCheck, inputAccessoryViewID, allowFontScaling) {
  var partial_arg = Props$BsReactNativeWeb.extendView(accessibilityLabel, accessible, hitSlop, onAccessibilityTap, onLayout, onMagicTap, responderHandlers, pointerEvents, removeClippedSubviews, style, testID, accessibilityComponentType, accessibilityLiveRegion, collapsable, importantForAccessibility, needsOffscreenAlphaCompositing, renderToHardwareTextureAndroid, accessibilityTraits, accessibilityViewIsModal, shouldRasterizeIOS, {
        autoCapitalize: UtilsRN$BsReactNativeWeb.option_map((function (x) {
                if (x >= -707897174) {
                  if (x >= 57776752) {
                    return "sentences";
                  } else {
        ...
        editable: editable,
        keyboardType: UtilsRN$BsReactNativeWeb.option_map((function (x) {
                if (x >= 511059466) {
                  if (x >= 734061261) {
                    if (x >= 965330242) {
                      if (x >= 1008346616) {
        ...
        returnKeyType: UtilsRN$BsReactNativeWeb.option_map((function (x) {
                if (x >= -487088280) {
                  if (x >= 23080) {
                    if (x >= 598785079) {
                      if (x >= 939679119) {
        ...
        textBreakStrategy: UtilsRN$BsReactNativeWeb.option_map((function (x) {
                if (x !== -128197688) {
                  if (x >= 947848242) {
                    return "simple";
                  } else {
        ...
        clearButtonMode: UtilsRN$BsReactNativeWeb.option_map((function (x) {
                if (x >= -894774937) {
                  if (x >= 422592140) {
                    return "never";
                  } else {
        ...
        dataDetectorTypes: UtilsRN$BsReactNativeWeb.option_map((function (param) {
        ...
        keyboardAppearance: UtilsRN$BsReactNativeWeb.option_map((function (x) {
                if (x !== -184774442) {
                  if (x >= 465819841) {
                    return "never";
                  } else {
