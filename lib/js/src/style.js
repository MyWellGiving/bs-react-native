...
var Encode$BsReactNativeWeb = require("./private/encode.js");
var UtilsRN$BsReactNativeWeb = require("./private/utilsRN.js");
var Platform$BsReactNativeWeb = require("./platform.js");

function encode_pt_pct(param) {
  if (param.tag) {
    return Encode$BsReactNativeWeb.pct(param[0]);
  } else {
    return param[0];
  }
}
...
function encode_pt_pct_auto(value) {
  if (typeof value === "number") {
    ...
    return Encode$BsReactNativeWeb.pct(value[0]);
  } else {
    return value[0];
  }
}
...
function combine(a, b) {
  return UtilsRN$BsReactNativeWeb.dictFromArray($$Array.append(UtilsRN$BsReactNativeWeb.dictEntries(a), UtilsRN$BsReactNativeWeb.dictEntries(b)));
}

var concat = $$Array.of_list;

var style = UtilsRN$BsReactNativeWeb.dictFromList;
...
function shadowOffset(height, width) {
  return /* tuple */[
          "shadowOffset",
          UtilsRN$BsReactNativeWeb.dictFromArray(/* array */[
                /* tuple */[
                  "height",
                  height
                ],
...
function create_(encoder, rotationEncoder, perspective, rotate, rotateX, rotateY, rotateZ, scaleX, scaleY, translateX, translateY, skewX, skewY) {
  ...
  var values = $$Array.fold_right((function (x, acc) {
          var match = x[1];
          if (match) {
            var val_ = UtilsRN$BsReactNativeWeb.dictFromArray(/* array */[/* tuple */[
                    x[0],
                    match[0]
                  ]]);
            return /* :: */[
...
function make(perspective, rotate, rotateX, rotateY, rotateZ, scaleX, scaleY, translateX, translateY, skewX, skewY, _) {
  return create_((function (value) {
                return UtilsRN$BsReactNativeWeb.option_map((function (prim) {
                              return prim;
                            }), value);
              }), (function (value) {
                return UtilsRN$BsReactNativeWeb.option_map((function (prim) {
...
function getPlatformBorderStyle(style, v) {
  var propertyName;
  try {
    Platform$BsReactNativeWeb.os(/* () */0);
    propertyName = "borderStyle";
  }
  catch (raw_exn){
    var exn = Js_exn.internalToOCamlException(raw_exn);
    if (exn[0] === Platform$BsReactNativeWeb.UnknownPlatform) {
      var match = +(exn[1] === "web");
      propertyName = match !== 0 ? style : "borderStyle";
    } else {
      throw exn;
    }
  }
...
function listStyle(type_, $staropt$star, $staropt$star$1, _) {
  var image = $staropt$star ? $staropt$star[0] : "";
  var position = $staropt$star$1 ? $staropt$star$1[0] : /* Outside */1;
  var tmp = image === "" ? "" : " " + image;
  return /* tuple */[
          "listStyle",
          string_of_listStyleType(type_) + (tmp + (" " + string_of_listStylePosition(position)))
        ];
}
...
/* Platform-BsReactNativeWeb Not a pure module */
