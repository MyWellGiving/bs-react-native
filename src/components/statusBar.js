...
function setHidden(hidden, animation, _) {
  ReactNative.StatusBar.setHidden(hidden, Js_undefined.fromOption(UtilsRN$BsReactNativeWeb.option_map((function (x) {
                  if (x !== -922086728) {
                    if (x >= -20462287) {
                      return "slide";
                    } else {
...
function make(animated, barStyle, hidden, backgroundColor, translucent, networkActivityIndicatorVisible, showHideTransition) {
  var partial_arg = {
    ...
    showHideTransition: UtilsRN$BsReactNativeWeb.option_map((function (x) {
            if (x !== -922086728) {
              if (x >= -20462287) {
                return "slide";
              } else {
