...
function serialize(handlers) {
  if (handlers !== undefined) {
    ...
    return {
            onMoveShouldSetResponder: UtilsRN$BsReactNativeWeb.option_map((function (g, x) {
                    return Curry._1(g, x);
                  }), handlers$1[/* onMoveShouldSetResponder */0]),
            onMoveShouldSetResponderCapture: UtilsRN$BsReactNativeWeb.option_map((function (g, x) {
                    return Curry._1(g, x);
            ...
            onStartShouldSetResponder: UtilsRN$BsReactNativeWeb.option_map((function (g, x) {
                    return Curry._1(g, x);
                  }), handlers$1[/* onStartShouldSetResponder */8]),
            onStartShouldSetResponderCapture: UtilsRN$BsReactNativeWeb.option_map((function (g, x) {
                    return Curry._1(g, x);
...
function extendView(accessibilityLabel, accessible, hitSlop, onAccessibilityTap, onLayout, onMagicTap, responderHandlers, pointerEvents, removeClippedSubviews, style, testID, accessibilityComponentType, accessibilityLiveRegion, collapsable, importantForAccessibility, needsOffscreenAlphaCompositing, renderToHardwareTextureAndroid, accessibilityTraits, accessibilityViewIsModal, shouldRasterizeIOS, moreProps) {
  return Object.assign({
              ...
              pointerEvents: UtilsRN$BsReactNativeWeb.option_map((function (x) {
                      if (x >= 416112227) {
                        if (x >= 427151639) {
                          return "box-only";
                        } else {
              ...
              accessibilityLiveRegion: UtilsRN$BsReactNativeWeb.option_map((function (x) {
                      if (x !== -114955603) {
                        if (x >= 536661202) {
                          return "assertive";
                        } else {
              ...
              importantForAccessibility: UtilsRN$BsReactNativeWeb.option_map((function (prop) {
                      if (prop >= 24641) {
                        if (prop >= 6039847) {
                          return "yes";
                        } else {
